            ...
            <div className="flex flex-col items-center justify-center h-screen">
                ...
                >
                    ...
                    <div className="absolute inset-0 flex items-center justify-center">
                        <div className="w-16 h-16 bg-linear-to-br from-amber-500 to-yellow-600 rounded-2xl flex items-center justify-center shadow-2xl shadow-amber-500/40">
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                >
                    <div className="flex items-start justify-between">
                        <div>
                            <h1 className="text-5xl font-bold bg-linear-to-r from-amber-400 via-orange-400 to-amber-500 bg-clip-text text-transparent mb-3 tracking-tight">
                                Maintenance Tickets
                            </h1>
                ...
                >
                    <button
                        ...
                        className={`group px-6 py-3 rounded-full font-bold transition-all duration-300 flex items-center space-x-2.5 ${filter === null
                            ? 'bg-linear-to-r from-blue-500 to-blue-600 text-white shadow-xl shadow-blue-500/40 scale-105'
                    ...
                    >
                        ...
                        <span className={`px-2.5 py-0.5 rounded-full text-xs font-bold ${filter === null ? 'bg-white/25' : 'bg-slate-700 text-slate-300'
                            }`}>
                            {totalCount}
                        </span>
                    </button>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-10">
                    ...
                    >
                        <div className="absolute left-0 top-0 bottom-0 w-1 bg-linear-to-b from-blue-500 to-blue-600"></div>
                    ...
                    <motion.div
                        ...
                        className={`glass-strong p-6 rounded-2xl border border-red-500/30 hover-lift hover:shadow-2xl transition-all duration-300 relative overflow-hidden ${openCount > 0 ? 'shadow-xl shadow-red-500/20 animate-pulse-slow' : ''
                            }`}
                    >
                        <div className="absolute left-0 top-0 bottom-0 w-1 bg-linear-to-b from-red-500 to-rose-600"></div>
                        <div className="flex items-start justify-between mb-5">
                            <div>
                                <p className="text-xs font-bold text-slate-400 uppercase tracking-widest mb-1">Open Tickets</p>
                            </div>
                            <div className="p-3 rounded-xl bg-linear-to-br from-red-500 to-rose-600 shadow-lg">
                                <svg className="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    >
                        <div className="absolute left-0 top-0 bottom-0 w-1 bg-linear-to-b from-emerald-500 to-green-600"></div>
                        <div className="flex items-start justify-between mb-5">
                            <div>
                                <p className="text-xs font-bold text-slate-400 uppercase tracking-widest mb-1">Resolved</p>
                            </div>
                            <div className="p-3 rounded-xl bg-linear-to-br from-emerald-500 to-green-600 shadow-lg">
                                <svg className="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                ...
                                {tickets.length === 0 ? (
                                    <tr>
                                        <td colSpan={7} className="px-6 py-20">
                                            ...
                                            >
                                                <div className="w-24 h-24 bg-linear-to-br from-emerald-500/20 to-green-600/20 rounded-full flex items-center justify-center mb-6">
