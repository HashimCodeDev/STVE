                                            ...
                                            <td className="px-6 py-4 whitespace-nowrap">
                                                <div className="flex items-center space-x-3">
                                                    <div className="flex-1 bg-slate-700/50 rounded-full h-2.5 w-24">
                                                        <div
                                                            className={`h-2.5 rounded-full transition-all duration-500 ${latestTrust && latestTrust.score >= 70 ? 'bg-gradient-to-r from-emerald-500 to-green-600 shadow-lg shadow-emerald-500/50' :
                                                                latestTrust && latestTrust.score >= 40 ? 'bg-gradient-to-r from-amber-500 to-yellow-600 shadow-lg shadow-amber-500/50' :
