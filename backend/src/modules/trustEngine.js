...
const TRUST_CONFIG = {
    ...
    TEMPORAL_THRESHOLDS: {
        moisture: { normal: 15, moderate: 35 },  // >35  = EXTREME
        temperature: { normal: 5, moderate: 12 },  // >12  = EXTREME
        ec: { normal: 12, moderate: 25 },  // >25  = EXTREME
        ph: { normal: 3, moderate: 8 },  // >8   = EXTREME
    },
    ...
    CROSS_THRESHOLDS: {
        moisture: { normal: 20, moderate: 40 },  // >40 = EXTREME
        temperature: { normal: 4, moderate: 8 },  // >8  = EXTREME
        ec: { normal: 12, moderate: 25 },  // >25 = EXTREME
        ph: { normal: 2, moderate: 5 },  // >5  = EXTREME
    },
...
export async function evaluateTrustScore(sensorId) {
    try {
        ...
        return {
            ...trustScore,
            label,              // add label for display purposes
